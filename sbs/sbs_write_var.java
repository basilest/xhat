...
//####################
public class sbs_write_var extends sbs_generic {
    
    public static final String  STR_KEYWORD = "setvalue";
    ...
    //  ####################
    public sbs_write_var (sbsTest test, int num, int y, int x1, int x2) {
         super(test, num, sbs_generic.WRITE_VAR, y);
         user_name    = "set var:?";
         CTypeName    = null;
         CTypeSize    = 0;
         this.x1      = x1;
...
//  ####################
    public sbs_write_var (sbsTest test, int num) {
         super(test, num, sbs_generic.WRITE_VAR, 0);
         user_name    = null;
         CTypeName    = null;
         CTypeSize    = 0;
         x1           = 0;
    ...
    //####################
    public sbs_write_var (sbs_write_var ori, int num, int y) {
         super(ori, num, y);
...
//              out.write (ParseTestFile.T_STR_ITMDSCKEY + DBDesckey + "\n");
        ...
        } catch (Exception e) {System.out.println("Unable to export Write Var "+ user_name);}  
    }       
    //####################
...
//           out.write(line);
//
//        } catch (Exception e) {System.out.println("Unable to export to Lis Set Var "+ user_name);}  
//    }       
//  ####################
    public void paintItem (Graphics g) {
        ...
        TextLayout textL      = new TextLayout("set:" + user_name, font, frc);
