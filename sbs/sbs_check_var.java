 ...
 */
//####################
public class sbs_check_var extends sbs_generic {
    
    public static final String  STR_KEYWORD = "checkvalue";
    int     x1;
    int     x2;
    int     textHigh  = 20;
    ...
    //####################
    public sbs_check_var (sbsTest test, int num, int x1, int x2, int y) {
         super(test, num, sbs_generic.CHECK_VAR, y);
         user_name      = "check var:?";
         CTypeName      = null;
         CTypeSize      = 0;         
         this.x1        = x1; 
    ...
    //####################
    public sbs_check_var (sbsTest test, int num) {
         super(test, num, sbs_generic.CHECK_VAR, 0);
         user_name      = null;
         CTypeName      = null;
         CTypeSize      = 0;         
         x1             = 0; 
    ...
    //####################
    public sbs_check_var (sbs_check_var ori, int num, int y) {
         super(ori, num, y);
...
//           out.write (ParseTestFile.T_STR_ITMDSCKEY + DBDesckey + "\n");
        ...
        } catch (Exception e) {System.out.println("Unable to export Check Var "+ user_name);}  
    }       
//    //####################
...
//    }       
    ...
    public void paintItem (Graphics g) {
        ...
        TextLayout textL      = new TextLayout("check:" + user_name, font, frc);
